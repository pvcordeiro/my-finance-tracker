        ...
        const validateEntries = (entries: any[]) => {
            return entries.every(
                (entry) =>
                    ...
                    entry.amounts.every(
                        (amount: any) => typeof amount === "number"
                    )
            );
        };
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Export your financial data as a JSON file for backup
                            or transfer.
                        </p>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        />
                        <p className="text-sm text-muted-foreground">
                            Import financial data from a previously exported
                            JSON file.
                        </p>
                    </div>
                    ...
                    {importStatus === "success" && (
                        <Alert className="border-emerald-200 bg-emerald-50">
                            ...
                            <AlertDescription className="text-emerald-800">
                                Data imported successfully! Your financial data
                                has been updated.
                            </AlertDescription>
                        </Alert>
                    )}
                    ...
                    <div className="space-y-2 pt-4 border-t">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Permanently delete all financial data. This action
                            cannot be undone.
                        </p>
                    </div>
                </CardContent>
