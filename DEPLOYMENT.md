...
3. **Run the deployment script:**
   ```bash
   cd /home/pi/finance-tracker-deploy/pi
...
```bash
# Manual backup
/home/username/finance-tracker/scripts/backup.sh

# View backup files
ls -la /home/username/finance-tracker-backups/

# Check database size
du -h /home/username/finance-tracker/data/finance.db
```
...
/home/username/finance-tracker/scripts/update.sh
```

## Directory Structure

```
/home/username/finance-tracker/
