...
import { cleanupExpiredAdminSessions } from "./admin-session.js";

let dbPath = path.join(process.cwd(), "data", "finance.db");
...
if (process.env.DATABASE_URL) {
  try {
    ...
    console.warn("Invalid DATABASE_URL, using default path:", error.message);
  }
}
let db = null;
