    ...
    <div className="min-h-screen finance-gradient">
      ...
      <main className="container mx-auto p-4 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-primary">Financial Details</h1>
            <p className="text-muted-foreground">Detailed view and data management</p>
          </div>
          <Button
            variant="outline"
            onClick={() => router.push("/")}
        ...
        <Tabs defaultValue="details" className="space-y-6">
          ...
          <TabsContent value="management">
            <DataManagement data={data} onImportData={handleImportData} onClearData={handleClearData} />
          </TabsContent>
        </Tabs>
