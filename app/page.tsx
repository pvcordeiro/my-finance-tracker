...
function HomePage() {
  ...
  const { data, hasChanges, saveData, updateBankAmount, addEntry, updateEntry, removeEntry } = useFinanceData()
      ...
      <main className="container mx-auto p-3 sm:p-4 space-y-4 sm:space-y-6 pb-24 sm:pb-6">
        ...
        <div className="space-y-4">
          <EntryForm
            ...
            onUpdateEntry={(id, field, value, monthIndex) => updateEntry("incomes", id, field, value, monthIndex)}
          ...
          <EntryForm
            ...
            onUpdateEntry={(id, field, value, monthIndex) => updateEntry("expenses", id, field, value, monthIndex)}
        ...
        <div className="fixed bottom-4 right-4 flex flex-col gap-2 z-40">
          ...
          <Button
            variant="secondary"
            className="shadow-lg transition-all duration-200 hover:scale-[1.05] active:scale-[0.95] touch-manipulation h-12 sm:h-10 px-4 sm:px-3"
          ...
          <Button
            variant="outline"
            className="shadow-lg transition-all duration-200 hover:scale-[1.05] active:scale-[0.95] bg-white/90 backdrop-blur-sm touch-manipulation h-12 sm:h-10 px-4 sm:px-3"
